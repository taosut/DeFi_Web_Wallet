<template>
  <div>
    ...
    <div v-else class="maincontent">
      <Account :address="address" :balance="balance" :symbol="symbol" :defiBalance="defiBalance"
    ...
    getTokenInfo() {
        this.trc20.methods.symbol().call().then(data => {
            ...
            this.web3.eth.getBalance(this.address).then(v => {
                v = new BigNumber(v);
                this.defiBalance = v.dividedBy(1e+18).toString(10);
            })
        })
    },
    getTransactions() {
